# Code Quality Conventions -- Meta-documentation

This document explains the document format, tooling integration, and design rationale behind the eight cognitive-mode code quality prompt files.

**Use when:** You need to understand why categories are split, how extraction works, or how to extend skill prompts that consume these documents.

Navigation index (convention table and applicability matrix): [../SKILL.md](../SKILL.md).
