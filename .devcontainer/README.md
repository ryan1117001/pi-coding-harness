...
| --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Node 24.19.0                                  | Digest-pinned Node image in [`Dockerfile`](Dockerfile)                                                                         | Update the image digest and matching assertions in `setup.sh` and `smoke-test.sh` together.                                                                                                          |
| pnpm 11.20.0                                  | Root [`package.json`](../package.json) `packageManager`                                                                        | Mirror the same version in the Dev Container Dockerfile, setup/smoke assertions, and web Dockerfile.                                                                                                 |
| Python 3.14.4                                 | Python Feature option in [`devcontainer.json`](devcontainer.json)                                                              | Regenerate `devcontainer-lock.json` and update setup/smoke assertions; keep the API image pin synchronized.                                                                                          |
| uv 0.12.2                                     | Digest-pinned uv image in [`Dockerfile`](Dockerfile)                                                                           | Update the digest and setup/smoke assertions together.                                                                                                                                               |
